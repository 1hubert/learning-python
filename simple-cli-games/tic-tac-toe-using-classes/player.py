...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        if state.current_winner == other_player:
            # we should return position AND score because
            # we need to keep track of the score for minmax to work
        ...
        if player == max_player:
            # we will be trying to increment our score
            # that's why our initial value for score will be -(infinity)
        ...
        for possible_move in state.available_moves():
            ...
            else:  # and minimize the other player
                if sim_score['score'] < best['score']:
                    best = sim_score  # replace best
